# utl-closed-form-solution-for-sample-size-in-a-clinical-equivalence-trial-using-r-and-sas-and-sympy
Closed form solution for sample size in a clinical equlivalence trial using r and sas and sympy
    %let pgm=utl-closed-form-solution-for-sample-size-in-a-clinical-equivalence-trial-using-r-and-sas-and-sympy;

    %stop_submission;

    Closed form solution for sample size in a clinical equivalence trial using r and sas and sympy
